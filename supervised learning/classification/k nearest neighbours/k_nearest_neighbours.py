...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = validation_size, random_state = seed)
    ...
    # CLASSIFICATION
        ...
        # IF BOOSTING FUNCTION WAS NOT DEFINED
            # create classification object
classifier = KNeighborsClassifier(n_neighbors = 5, metric = 'minkowski', p = 2) # minkowski and p=2 yield a euclidean distance
...
# the cm will yield some wrong predictions - this is because the KNN model has not overfit itself to the training data
print(cm)
